(define (problem sokoban-3rows-4cols-2boxes-37)
                        (:domain sokoban)
                        (:objects
                          sokoban1
                        ...
                        (:init
                           ...
                           (clear pos0_1) (clear pos0_2) (clear pos1_0) (clear pos1_1) (clear pos1_2) (clear pos1_3) (clear pos2_1) (clear pos2_2) (clear pos2_3)
                           (at sokoban1 pos0_0)
