(define (problem sokoban-4rows-4cols-2boxes-101)
                        (:domain sokoban)
                        (:objects
                          sokoban1
                        ...
                        (:init
                           ...
                           (clear pos0_1) (clear pos0_2) (clear pos0_3) (clear pos1_0) (clear pos1_1) (clear pos1_2) (clear pos1_3) (clear pos2_1) (clear pos2_2) (clear pos2_3) (clear pos3_0) (clear pos3_1) (clear pos3_3)
                           (at sokoban1 pos0_0)
                           ...
                           (at crate0 pos2_0) (at crate1 pos3_2)
                        )
                        (:goal (and
                           (at sokoban1 pos0_0)
                        )))