(define (problem strips-gripper-x-2)
  ...
  (:objects ball1 ball2 leftgrip rightgrip leftroom rightroom slot1 slot2 slot3 slot4)
  ...
  (:goal (and (at ball1 rightroom) (at ball2 rightroom)))
)
