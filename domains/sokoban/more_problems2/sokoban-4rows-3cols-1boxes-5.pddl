(define (problem sokoban-4rows-3cols-1boxes-5)
                        (:domain sokoban)
                        (:objects
                          sokoban1
                        ...
                        (:init
                           (sokoban sokoban1)
                           (crate crate0)
                           (clear pos0_1) (clear pos0_2) (clear pos1_0) (clear pos1_2) (clear pos2_0) (clear pos2_1) (clear pos2_2) (clear pos3_0) (clear pos3_1) (clear pos3_2)
                           (at sokoban1 pos0_0)
