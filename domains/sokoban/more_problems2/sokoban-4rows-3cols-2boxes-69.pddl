(define (problem sokoban-4rows-3cols-2boxes-69)
                        (:domain sokoban)
                        (:objects
                          sokoban1
                        ...
                        (:init
                           ...
                           (clear pos0_1) (clear pos0_2) (clear pos1_0) (clear pos1_1) (clear pos1_2) (clear pos2_0) (clear pos2_1) (clear pos2_2) (clear pos3_1)
                           (at sokoban1 pos0_0)
